...
public class HttpUtil {
    ...
    public static String postClient(String clientURL, Map<String, String> params) {
		...
		String resp = postClient(client,clientURL, params);
		return resp;
	}

	public static String postClient(CloseableHttpClient client, String clientURL, Map<String, String> params) {
		String resp = postClient(client, clientURL, params, CHARSET, TIMEOUT);
		return resp;
	}
	 ...
	 * @return
	 */
	public static String postClient(String clientURL, Map<String, String> params, String charset, int
			timeout) {
		CloseableHttpClient client = HttpClients.createDefault();
		return postClient(client, clientURL, params, charset, timeout);
	}
	 ...
	 * @return
	 */
	public static String postClient(CloseableHttpClient client, String clientURL, Map<String, String> params, String charset, int
			timeout){
		HttpPost post = new HttpPost(clientURL);
		//将client作为入参 @author yecy 20171231
//		CloseableHttpClient client = HttpClients.createDefault();
		String result = "";
		try {
			//参数封装
	...
	public static HttpResponse httpPostByAttachment(String clientURL, Map<String, String> parasMap){
		try {
			...
			for (String key : parasMap.keySet()) {
				StringBody stringBody = new StringBody(parasMap.get(key), Charset.forName(CHARSET));
	 ...
	 * @return
	 * @author yecy 20180101
	 */
	public static CloseableHttpClient getRetryClient(int maxRetries, int retryInterval) {
		DefaultServiceUnavailableRetryStrategy serviceUnavailableRetryStrategy = new
                DefaultServiceUnavailableRetryStrategy(maxRetries, retryInterval);
